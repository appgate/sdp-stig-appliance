...
[`CAN_Ubuntu_24-04_STIG001.003.006MAC-2_Public_tailored_tailoring.xml`](./CAN_Ubuntu_24-04_STIG001.003.006MAC-2_Public_tailored_tailoring.xml) is used by internal scans to achieve the advertised score. Please contact an AppGate ZTNA representative to obtain a copy of the attestation that explains the justifications for exclusions specified in this tailoring file.
